...
def get_interface_speed(interface_name):
    ...
    if 'fast' in interface_name.lower():
        return 100
# Filters are added to the ENV object after declaration. Note that

# actually passing in our "get_interface_speed" function and not
...
# We load our YAML file and pass it in to the template when renderingit.
